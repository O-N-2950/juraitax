// ═══════════════════════════════════════════════════════════════
//  tAIx — Serveur Express
//  - Sert le build Vite (dist/)
//  - Proxy /api/ocr → api.anthropic.com (évite le blocage CORS browser)
//  - Proxy /api/advisor → api.anthropic.com
...
app.listen(PORT, () => {
  console.log(`tAIx server running on port ${PORT}`);
  console.log(`API key: ${ANTHROPIC_API_KEY ? "✓ présente" : "✗ MANQUANTE"}`);
});
